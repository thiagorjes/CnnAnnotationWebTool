...
cores = [(255,0,0),(0,255,0),(0,0,255),(0,255,255),(255,255,0),(255,0,255),(128,128,128)]

#cores = [(255,0,0),(0,255,0),(0,0,255),(0,255,255)]

def main(labels_path, images_path,format):
    for label_file in sorted(os.listdir(labels_path)):
        try:
            f = open(labels_path + label_file, "r")
            print(images_path + label_file.replace('txt', format))
            img = cv2.imread(images_path + label_file.replace('txt', format))
...
if len(sys.argv) == 5:
    ...
    print("\nusage: python " +
          sys.argv[0]+" labels/path/ images/path/ -format [jpg|png]\n")
